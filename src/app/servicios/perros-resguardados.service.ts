import { Resguardado } from './../perdidos/formulario-resguardado/resguardado.model';
...
export class PerrosResguardadosService {
  public todosPerrosResguardados: any;
  constructor(private http: HttpClient) { }

  mandarAnuncioResguardado(data: Resguardado) {
    console.log(data);
    return this.http.post('https://findme-proyecto-9d68a.firebaseio.com/mensajes-resguardados.json', data);
  }
